        ...
        <Row className="p-4">
          <Col>
            {activeSection === 'requests' && (
              <Card className="admin-card">
                <Card.Header>
                  <h5 className="text-warning mb-0">Deposit/Withdraw Requests</h5>
                </Card.Header>
                <Card.Body>
                    ...
                    <tbody>
                      {requests.map(request => (
                        <tr key={request.id}>
                          ...
                          <td>{request.user}</td>
                          <td>
                            <span className={`badge ${request.type === 'Deposit' ? 'bg-info' : 'bg-secondary'}`}>
                              {request.type}
                            </span>
                          </td>
            ...
            {activeSection === 'cash' && (
              <Card className="admin-card">
                <Card.Header>
                  <h5 className="text-warning mb-0">Cash Management</h5>
                </Card.Header>
                <Card.Body>
                  <Row>
                    <Col md={6}>
